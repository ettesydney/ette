...
export default function PlaceHolder() {
  return (
    <div className="h-screen flex flex-col justify-between items-center relative text-primary p-4">
      {/* Centered Content */}
      <div className="container mx-auto grid grid-cols-12 gap-4 flex-grow text-center items-center">
        {/* Main Content (Offset on Large Screens) */}
        <div className="col-span-12 lg:col-start-5 lg:col-span-4 flex flex-col items-center justify-center gap-6">
          ...
          <div className="w-full h-auto relative flex justify-center items-center">
            <Image src={etteLogo} alt="ette Logo" width={400} height={200} objectFit="contain" />
          </div>
          <div>
