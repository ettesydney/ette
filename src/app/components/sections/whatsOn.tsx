...
export default async function WhatsOn() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center bg-primarylight w-full mb-[5rem] lg:mb-[10rem]">
    ...
    {/* Section Title */}
      ...
      <div
        className={`
          hidden lg:grid
          gap-6
          w-full max-w-[800px] mb-[2rem]
          ${whatsOnData.events?.length === 1
            ? 'grid-cols-1 justify-items-center'
            : 'grid-cols-1 md:grid-cols-2 justify-items-stretch'}
        `}
      >
